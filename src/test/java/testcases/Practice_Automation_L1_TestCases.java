...
/******************* */
	@Test(priority = 23, groups = { "sanity" }, description = "Check if we have Tax defined after product name.")
	...
	@Test(priority = 24, groups = { "sanity" }, description = "Check if we have Tax defined in correct format or not.")
	...
	@Test(priority = 25, groups = {
			"sanity" }, description = "Validate if we have an option to remove an added product or not.")
	...
	@Test(priority = 26, groups = { "sanity" }, description = "Remove a product.")
	...
	@Test(priority = 27, groups = {
			"sanity" }, description = "Validate if we get a message after removing an item with its name or not.")
	...
	@Test(priority = 28, groups = {
			"sanity" }, description = "Update the quantity of one of the product. Increase quantity by 1")
	...
	@Test(priority = 29, groups = {
			"sanity" }, description = "Validate if we have active Update Basket button active on updating quantity or not.")
	...
	@Test(priority = 30, groups = {
			"sanity" }, description = "Validate if we have a “Proceed to checkout” button or not.")
	...
	@Test(priority = 31, groups = { "sanity" }, description = "Click on “Proceed to checkout” button.")
	...
	@Test(priority = 32, groups = {
			"sanity" }, description = "On clicking it, validate do we navigate to Billing Details page having “Billing Details” as heading or not")
